...
export const MainPage: FC = appLayout((): JSX.Element => {
  ...
  const testImages = [
    ...
    { id: '4', img: './img/users/user-01.jpg', href: '/', name: 'Indie Game Developer', users: '450 followers' },
    { id: '5', img: './img/users/user-02.jpg', href: '/', name: 'Travel Vlogger', users: '300 followers' },
    { id: '6', img: './img/users/user-03.jpg', href: '/', name: 'Fitness Instructor', users: '200 followers' },
  ];
